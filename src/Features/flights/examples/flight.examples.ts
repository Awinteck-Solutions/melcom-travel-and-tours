...
export const CommonMappings = {
  airports: {
    popular: [
      ...
      {
        code: WestAfricanAirports.LAGOS,
        name: "Lagos - Murtala Muhammed International",
        country: "Nigeria",
      },
      {
        code: InternationalAirports.LONDON_HEATHROW,
        name: "London - Heathrow",
        country: "United Kingdom",
      },
      {
        code: InternationalAirports.NEW_YORK_JFK,
        name: "New York - John F. Kennedy International",
        country: "United States",
      },
      {
        code: InternationalAirports.DUBAI,
        name: "Dubai International",
        country: "United Arab Emirates",
      },
      {
        code: InternationalAirports.PARIS_CDG,
  ...
  airlines: {
    popular: [
      {
        code: Airlines.BRITISH_AIRWAYS,
        name: "British Airways",
        alliance: "Oneworld",
      },
      {
        code: Airlines.VIRGIN_ATLANTIC,
